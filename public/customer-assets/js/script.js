function iso13616Prepare(iban) {
    ...
    return iban.split('').map(function (n) { var code = n.charCodeAt(0); if (code >= A && code <= Z) {return code - A + 10;} else {return n;}}).join('');
}
...
$(document).ready(function () {
    ...
    $('.creditcart-input').on('input',function(e){
        ...
        document.querySelector('.creditcart>img').src = "https://shaba.smohammadabedy.ir/bank-iran/"+bankData[0]+".png";
    });
        ...
        .on('input', function () {
            ...
            setTimeout(function(){
                ...
                if (shaba.length >= 6) {
					...
					document.querySelector('.shaba-number>img').src = "https://shaba.smohammadabedy.ir/bank-iran/"+shabbankd[0]+".png"
                }
                if (shaba.length === 0) {
